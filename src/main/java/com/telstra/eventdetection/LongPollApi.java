...
import com.telstra.eventdetection.GetEventResponse;
import com.telstra.eventdetection.PollingObj;
...
public class LongPollApi {
    ...
    public LongPollApi(ApiClient apiClient) {
     ...
     * @param body List of MSISDNs to pull the events (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call longpollCall(String eventType, PollingObj body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call longpollValidateBeforeCall(String eventType, PollingObj body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'eventType' is set
        if (eventType == null) {
            throw new ApiException("Missing the required parameter 'eventType' when calling longpoll(Async)");
        }
        
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling longpoll(Async)");
        }
        

        com.squareup.okhttp.Call call = longpollCall(eventType, body, progressListener, progressRequestListener);
        return call;
     ...
     */
    public GetEventResponse longpoll(String eventType, PollingObj body) throws ApiException {
        ApiResponse<GetEventResponse> resp = longpollWithHttpInfo(eventType, body);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<GetEventResponse> longpollWithHttpInfo(String eventType, PollingObj body) throws ApiException {
        com.squareup.okhttp.Call call = longpollValidateBeforeCall(eventType, body, null, null);
     ...
     */
    public com.squareup.okhttp.Call longpollAsync(String eventType, PollingObj body, final ApiCallback<GetEventResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = longpollValidateBeforeCall(eventType, body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GetEventResponse>(){}.getType();
