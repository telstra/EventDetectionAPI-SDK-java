...
import com.telstra.eventdetection.NotificationPayload;
import com.telstra.eventdetection.PushNotificationObj;
...
public class PushNotificationsApi {
    ...
    /**
     * Build call for pushNotifications
     * @param contentType application/json (required)
     * @param body Application Id, MSISDN, Event Id and Event Date (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call pushNotificationsCall(String contentType, NotificationPayload body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;

        // create path and map variables
        String localVarPath = "/v1/eventdetection/events/notifications";
    ...
    private com.squareup.okhttp.Call pushNotificationsValidateBeforeCall(String contentType, NotificationPayload body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'contentType' is set
        if (contentType == null) {
            throw new ApiException("Missing the required parameter 'contentType' when calling pushNotifications(Async)");
        }
        
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling pushNotifications(Async)");
        }
        

        com.squareup.okhttp.Call call = pushNotificationsCall(contentType, body, progressListener, progressRequestListener);
        return call;
     ...
     */
    public PushNotificationObj pushNotifications(String contentType, NotificationPayload body) throws ApiException {
        ApiResponse<PushNotificationObj> resp = pushNotificationsWithHttpInfo(contentType, body);
        return resp.getData();
    }
     ...
     * @param contentType application/json (required)
     * @param body Application Id, MSISDN, Event Id and Event Date (required)
     * @return ApiResponse&lt;PushNotificationObj&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PushNotificationObj> pushNotificationsWithHttpInfo(String contentType, NotificationPayload body) throws ApiException {
        com.squareup.okhttp.Call call = pushNotificationsValidateBeforeCall(contentType, body, null, null);
        Type localVarReturnType = new TypeToken<PushNotificationObj>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Push event notifications (asynchronously)
     * Push event notifications to the notification URL configured during the MSISDN registration process
     * @param contentType application/json (required)
     * @param body Application Id, MSISDN, Event Id and Event Date (required)
     ...
     */
    public com.squareup.okhttp.Call pushNotificationsAsync(String contentType, NotificationPayload body, final ApiCallback<PushNotificationObj> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = pushNotificationsValidateBeforeCall(contentType, body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PushNotificationObj>(){}.getType();
