...
import com.telstra.eventdetection.Subscriptionattr;
 ...
 */
@ApiModel(description = "This is the interface to get subscription details for a phone number. The number must be a registered number. The response depends on the type of event..")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2018-03-29T16:22:32.700+11:00")
public class GetSubscriptionResponse {
  @SerializedName("notificationURL")
  private String notificationURL = null;

  @SerializedName("subscriptions")
  private List<Subscriptionattr> subscriptions = new ArrayList<Subscriptionattr>();

  public GetSubscriptionResponse notificationURL(String notificationURL) {
  ...
  **/
  @ApiModelProperty(value = "Notification URL")
  ...
  public GetSubscriptionResponse subscriptions(List<Subscriptionattr> subscriptions) {
    this.subscriptions = subscriptions;
    return this;
  }

  public GetSubscriptionResponse addSubscriptionsItem(Subscriptionattr subscriptionsItem) {
  ...
  **/
  @ApiModelProperty(required = true, value = "Array containing the object with values for phone number and subscription attributes")
  public List<Subscriptionattr> getSubscriptions() {
    return subscriptions;
  }

  public void setSubscriptions(List<Subscriptionattr> subscriptions) {
    this.subscriptions = subscriptions;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.notificationURL, getSubscriptionResponse.notificationURL) &&
        Objects.equals(this.subscriptions, getSubscriptionResponse.subscriptions);
  }

  @Override
  public int hashCode() {
    return Objects.hash(notificationURL, subscriptions);
  }
