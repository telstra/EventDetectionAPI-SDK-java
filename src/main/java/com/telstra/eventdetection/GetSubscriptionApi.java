...
import com.telstra.eventdetection.GetSubscriptionResponse;
import com.telstra.eventdetection.PhoneNumberList;
...
public class GetSubscriptionApi {
    ...
    public GetSubscriptionApi() {
        this(Configuration.getDefaultApiClient());
    }

    public GetSubscriptionApi(ApiClient apiClient) {
     ...
     * @param body List of subscribed phone numbers (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getSubscriptionCall(PhoneNumberList body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;

        // create path and map variables
        String localVarPath = "/v1/eventdetection/events/subscriptions";
    ...
    private com.squareup.okhttp.Call getSubscriptionValidateBeforeCall(PhoneNumberList body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling getSubscription(Async)");
        }
        

        com.squareup.okhttp.Call call = getSubscriptionCall(body, progressListener, progressRequestListener);
        return call;
     ...
     */
    public GetSubscriptionResponse getSubscription(PhoneNumberList body) throws ApiException {
        ApiResponse<GetSubscriptionResponse> resp = getSubscriptionWithHttpInfo(body);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<GetSubscriptionResponse> getSubscriptionWithHttpInfo(PhoneNumberList body) throws ApiException {
        com.squareup.okhttp.Call call = getSubscriptionValidateBeforeCall(body, null, null);
     ...
     */
    public com.squareup.okhttp.Call getSubscriptionAsync(PhoneNumberList body, final ApiCallback<GetSubscriptionResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getSubscriptionValidateBeforeCall(body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GetSubscriptionResponse>(){}.getType();
