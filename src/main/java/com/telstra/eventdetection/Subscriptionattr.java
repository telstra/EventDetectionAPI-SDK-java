...
public class Subscriptionattr {
  ...
  public Subscriptionattr msisdn(String msisdn) {
    this.msisdn = msisdn;
    return this;
  }
  ...
  **/
  ...
  public Subscriptionattr events(List<String> events) {
    this.events = events;
    return this;
  }

  public Subscriptionattr addEventsItem(String eventsItem) {
   ...
   * @return events
  **/
  @ApiModelProperty(required = true, value = "Array of subscribed events")
  ...
  public Subscriptionattr carrierName(String carrierName) {
   ...
   * @return carrierName
  **/
  @ApiModelProperty(required = true, value = "Carrier name for the MSISDN")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    Subscriptionattr subscriptionattr = (Subscriptionattr) o;
    return Objects.equals(this.msisdn, subscriptionattr.msisdn) &&
        Objects.equals(this.events, subscriptionattr.events) &&
        Objects.equals(this.carrierName, subscriptionattr.carrierName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(msisdn, events, carrierName);
  }
  ...
  public String toString() {
    ...
    sb.append("class Subscriptionattr {\n");
