...
import com.telstra.eventdetection.Test;
...
public class ResisterPhoneNumberList {
  @SerializedName("msisdns")
  private List<Test> msisdns = null;

  public ResisterPhoneNumberList msisdns(List<Test> msisdns) {
    this.msisdns = msisdns;
    return this;
  }

  public ResisterPhoneNumberList addMsisdnsItem(Test msisdnsItem) {
    if (this.msisdns == null) {
      this.msisdns = new ArrayList<Test>();
    }
   ...
   * @return msisdns
  **/
  @ApiModelProperty(value = "MSISDNs array")
  public List<Test> getMsisdns() {
    return msisdns;
  }

  public void setMsisdns(List<Test> msisdns) {
    this.msisdns = msisdns;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ResisterPhoneNumberList resisterPhoneNumberList = (ResisterPhoneNumberList) o;
    return Objects.equals(this.msisdns, resisterPhoneNumberList.msisdns);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResisterPhoneNumberList {\n");
