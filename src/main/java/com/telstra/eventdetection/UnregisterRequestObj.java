...
public class UnregisterRequestObj {
  ...
  public UnregisterRequestObj notificationURL(String notificationURL) {
  ...
  **/
  ...
  public UnregisterRequestObj msisdns(List<String> msisdns) {
    this.msisdns = msisdns;
    return this;
  }

  public UnregisterRequestObj addMsisdnsItem(String msisdnsItem) {
   ...
   * @return msisdns
  **/
  @ApiModelProperty(value = "list of msisdns")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    UnregisterRequestObj unregisterRequestObj = (UnregisterRequestObj) o;
    return Objects.equals(this.notificationURL, unregisterRequestObj.notificationURL) &&
        Objects.equals(this.msisdns, unregisterRequestObj.msisdns);
  }

  @Override
  public int hashCode() {
    return Objects.hash(notificationURL, msisdns);
  }
  ...
  public String toString() {
    ...
    sb.append("class UnregisterRequestObj {\n");
