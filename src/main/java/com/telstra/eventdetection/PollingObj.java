...
public class PollingObj {
  @SerializedName("msisdns")
  private List<String> msisdns = new ArrayList<String>();

  public PollingObj msisdns(List<String> msisdns) {
    this.msisdns = msisdns;
    return this;
  }

  public PollingObj addMsisdnsItem(String msisdnsItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PollingObj pollingObj = (PollingObj) o;
    return Objects.equals(this.msisdns, pollingObj.msisdns);
  }
