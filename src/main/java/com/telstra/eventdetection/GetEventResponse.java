...
import com.telstra.eventdetection.Eventsattr;
 ...
 */
@ApiModel(description = "This is the interface to get event details for a phone number. The number must be a registered number. The response depends on the type of event.")
...
public class GetEventResponse {
  ...
  private List<Eventsattr> msisdns = new ArrayList<Eventsattr>();

  public GetEventResponse eventType(String eventType) {
  ...
  **/
  ...
  public GetEventResponse msisdns(List<Eventsattr> msisdns) {
    this.msisdns = msisdns;
    return this;
  }

  public GetEventResponse addMsisdnsItem(Eventsattr msisdnsItem) {
   ...
   * @return msisdns
  **/
  @ApiModelProperty(required = true, value = "Array containing the object with evnt attributes")
  public List<Eventsattr> getMsisdns() {
    return msisdns;
  }

  public void setMsisdns(List<Eventsattr> msisdns) {
    this.msisdns = msisdns;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.eventType, getEventResponse.eventType) &&
        Objects.equals(this.msisdns, getEventResponse.msisdns);
  }

  @Override
  public int hashCode() {
    return Objects.hash(eventType, msisdns);
  }
