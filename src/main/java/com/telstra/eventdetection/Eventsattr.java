...
import com.telstra.eventdetection.ServiceEventsAttr;
...
public class Eventsattr {
  ...
  @SerializedName("mobileServiceEvents")
  private List<ServiceEventsAttr> mobileServiceEvents = new ArrayList<ServiceEventsAttr>();

  public Eventsattr msisdn(String msisdn) {
    this.msisdn = msisdn;
    return this;
  }
  ...
  **/
  ...
  public Eventsattr mobileServiceEvents(List<ServiceEventsAttr> mobileServiceEvents) {
    this.mobileServiceEvents = mobileServiceEvents;
    return this;
  }

  public Eventsattr addMobileServiceEventsItem(ServiceEventsAttr mobileServiceEventsItem) {
    this.mobileServiceEvents.add(mobileServiceEventsItem);
    return this;
  }

   /**
   * Array of mobile events
   * @return mobileServiceEvents
  **/
  @ApiModelProperty(required = true, value = "Array of mobile events")
  public List<ServiceEventsAttr> getMobileServiceEvents() {
    return mobileServiceEvents;
  }

  public void setMobileServiceEvents(List<ServiceEventsAttr> mobileServiceEvents) {
    this.mobileServiceEvents = mobileServiceEvents;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    Eventsattr eventsattr = (Eventsattr) o;
    return Objects.equals(this.msisdn, eventsattr.msisdn) &&
        Objects.equals(this.mobileServiceEvents, eventsattr.mobileServiceEvents);
  }

  @Override
  public int hashCode() {
    return Objects.hash(msisdn, mobileServiceEvents);
  }
  ...
  public String toString() {
    ...
    sb.append("class Eventsattr {\n");
    
    sb.append("    msisdn: ").append(toIndentedString(msisdn)).append("\n");
    sb.append("    mobileServiceEvents: ").append(toIndentedString(mobileServiceEvents)).append("\n");
    sb.append("}");
    return sb.toString();
  }
