...
public class SubscriptionObj {
  ...
  public SubscriptionObj msisdns(List<String> msisdns) {
    this.msisdns = msisdns;
    return this;
  }

  public SubscriptionObj addMsisdnsItem(String msisdnsItem) {
   ...
   * @return msisdns
  **/
  @ApiModelProperty(required = true, value = "List of Phone numbers")
  ...
  public SubscriptionObj notificationURL(String notificationURL) {
  ...
  **/
  ...
  public SubscriptionObj eventType(String eventType) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SubscriptionObj subscriptionObj = (SubscriptionObj) o;
    return Objects.equals(this.msisdns, subscriptionObj.msisdns) &&
        Objects.equals(this.notificationURL, subscriptionObj.notificationURL) &&
        Objects.equals(this.eventType, subscriptionObj.eventType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(msisdns, notificationURL, eventType);
  }
  ...
  public String toString() {
    ...
    sb.append("class SubscriptionObj {\n");
