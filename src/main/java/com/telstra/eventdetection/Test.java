...
public class Test {
  ...
  public Test msisdn(String msisdn) {
    this.msisdn = msisdn;
    return this;
  }
  ...
  **/
   ...
   * @return description
  **/
  @ApiModelProperty(value = "description about the registration status")
  ...
  public Test carrierName(String carrierName) {
   ...
   * @return carrierName
  **/
  @ApiModelProperty(value = "carrier name for the msisdn")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    Test test = (Test) o;
    return Objects.equals(this.msisdn, test.msisdn) &&
        Objects.equals(this.description, test.description) &&
        Objects.equals(this.carrierName, test.carrierName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(msisdn, description, carrierName);
  }
